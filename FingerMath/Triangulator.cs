namespace FingerMath
{
    ...
    public class Triangulator
    {
        ...
        public static List<int> Triangulate(VectorF[] points, bool arePointsCcw = true)
        {
        ...
        public static bool IsTriangleCcw(VectorF a, VectorF center, VectorF c)
        {
            return Cross(center - a, c - center) < 0;
        }

        public static bool TestPointTriangle(VectorF point, VectorF a, VectorF b, VectorF c)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float Cross(VectorF u, VectorF v)
        {
